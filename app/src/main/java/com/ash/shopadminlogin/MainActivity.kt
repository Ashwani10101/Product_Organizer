...
import com.ash.shopadminlogin.LocalDatabase.MyDatabase
...
class MainActivity : AppCompatActivity() {
    ...
    companion object
    {
        ...
        var productDatabase :MyDatabase? = null
    }
    ...
    private fun initRecycleView()
    {
        ...
        reycleviewMain.layoutManager = LinearLayoutManager(
            this,
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val productListWithoutImages = ArrayList(productDatabase!!.productDao().products())
        ...
        when(requestCode)
        {
            ADD_NEW_PRODUCT -> {
                ...
                if (productEntity != null) {
                    productEntity.image = Helper.getThumbnail(
                        applicationContext,
                        productEntity.imageID.toString()
                    )

                    recyclerviewAdaptor.addProduct(productEntity, recyclerviewAdaptor.itemCount)
                    CoroutineScope(Dispatchers.IO).launch {
                        productDatabase!!.productDao().addNewProduct(productEntity)
                    }
                }
            }
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean
    {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(query: String?): Boolean {   //Coroutine added
